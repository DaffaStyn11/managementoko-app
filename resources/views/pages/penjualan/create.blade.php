        ...
        <div id="mainContent" class="ml-64 w-full transition-all duration-300 min-h-screen flex flex-col">
            ...
            <main class="p-6 flex-grow">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-500 text-sm mt-1">Catat transaksi penjualan baru.</p>
                </div>
                        ...
                        <form action="{{ route('penjualan.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="kode_penjualan" id="kode_penjualan"
                                        value="{{ old('kode_penjualan', $kode_penjualan) }}"
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="keterangan" id="keterangan" rows="3"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                                    placeholder="Catatan penjualan...">{{ old('keterangan') }}</textarea>
                            </div>
