...
@section('content')
        ...
        <div id="mainContent" class="ml-64 w-full transition-all duration-300 min-h-screen flex flex-col">
            ...
            <main class="p-6 flex-grow">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-500 text-sm mt-1">Tambahkan transaksi pembelian baru.</p>
                </div>
                        ...
                        <form action="{{ route('pembelian.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="kode_pembelian" id="kode_pembelian"
                                        value="{{ old('kode_pembelian', $kode_pembelian) }}"
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="keterangan" id="keterangan" rows="3"
                                    ...
                                    placeholder="Catatan pembelian...">{{ old('keterangan') }}</textarea>
                            </div>
    ...
    <script>
        ...
        // Load produk jika ada old value
